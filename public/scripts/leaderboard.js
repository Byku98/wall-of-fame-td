    document.addEventListener('DOMContentLoaded', () => {
      ...
      const renderTable = (laps) => {
        ...
        if (laps.length === 0) {
          leaderboardTableBody.innerHTML = '<tr><td colspan="8" class="text-center">Brak czasów dla wybranego toru.</td></tr>';
        } else {
